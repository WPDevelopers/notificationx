...
if( ! class_exists( 'WPDeveloper_Dashboard_Widget' ) ) {
    class WPDeveloper_Dashboard_Widget {
        ...
        public function add_dashboard_widgets() {
            wp_add_dashboard_widget('wpdev_feed_widget', __('WPDeveloper Feed', 'notificationx'), [ $this, 'feed' ]);
        }
        ...
        public function feed() {
            ...
            if (is_wp_error($rss)) {
                $output .= '<li>' . __('No recent news.', 'notificationx') . '</li>';
            } else {
            ...
            $output .= '</ul>';
            $output .= '<p>' . __('Keep Your Eyes on', 'notificationx') . ' <a href="https://wpdeveloper.net" target="_blank">WPDeveloper</a></p>';
            echo $output;
        }
    }
}
