        ...
        $this->themes = [
            'theme-two'   => [
                ...
                'defaults' => [
                    ...
                    'button_icon'                 => 'none',
                    'bar_bg_color'                => '#5807a2',
                    'press_content'               => wp_kses_post( sprintf( '<b>%s</b>', esc_html__( "We're excited to introduce something new!", 'notificationx' ) ) ),
            ...
            'theme-four' => [
                ...
                'defaults' => [
                    'enable_countdown'            => 1,
                    'press_content'               => wp_kses_post( sprintf( '<p><span style="color: #F54747;">%s</span> %s</p>', esc_html__( '4 Years', 'notificationx' ), esc_html__( 'Of Seamlessly Creating NotificationX!', 'notificationx' ) )),
            ...
            'theme-five' => [
                ...
                'column'  => "12",
                'defaults' => [
                    'press_content'               => wp_kses_post( sprintf( '<p><span style="color: #fff;">%s</span> %s</p>', esc_html__( '🎁 Flash 30%', 'notificationx' ), esc_html__( 'Sale is On Now! Don’t miss out on this opportunity', 'notificationx' ) ) ),
                    'enable_countdown'            => 1,
                    'nx_bar_border_radius_left'   => 16,
                    'nx_bar_border_radius_right'  => 16,
                    'nx_bar_border_radius_top'    => 16,
            ...
            'theme-six' => [
                ...
                'column'  => "12",
                'defaults' => [
                    'press_content'               => wp_kses_post( sprintf( '<p><span style="color: #000;">%s</span> %s</p>', esc_html__( '🎁 Flash 30%', 'notificationx' ), esc_html__( 'Sale is On Now! Don’t miss out on this opportunity', 'notificationx' ) ) ),
                    'enable_countdown'            => 1,
                    'nx_bar_border_radius_left'   => 16,
                    'nx_bar_border_radius_right'  => 16,
                    'nx_bar_border_radius_top'    => 16,
            ...
            'theme-seven' => [
                ...
                'column'  => "12",
                'defaults' => [
                    'press_content'               => wp_kses_post( sprintf( '<p><span style="color: #9F7800;">%s</span> %s</p>', esc_html__( '4 years', 'notificationx' ),  esc_html__( 'Of Seamlessly Creating NotificationX!', 'notificationx' ) ) ),
                    'enable_countdown'            => 0,
                    'nx_bar_border_radius_left'   => 0,
                    'nx_bar_border_radius_right'  => 0,
                    'nx_bar_border_radius_top'    => 0,
