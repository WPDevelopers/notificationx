...
class GoogleReviews extends Extension {
    ...
    public function init_extension()
    {
        ...
        $this->popup = [
            ...
            "html"              => wp_kses_post( printf( '<span>%s</span>',  esc_html__( 'Google reviews provide helpful information and make your business stand out.', 'notificationx' ) ) ),
        ];
    }
    ...
    public function doc(){
        ...
        /* translators: 
            %1$s: URL to the Google Reviews API settings page in the WordPress admin, 
            %2$s: URL to the step-by-step documentation for Google Reviews API setup, 
            %3$s: URL to the NotificationX integration guide for Google Reviews 
        */
