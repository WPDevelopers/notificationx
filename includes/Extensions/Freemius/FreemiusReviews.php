...
class FreemiusReviews extends Extension {
    ...
    public function init_extension()
    {
        ...
        $this->popup = [
            ...
            /* translators: Description about review teasers. Do not include HTML tags in the translation. */
            "html" => '<span>' . wp_kses_post( __( 'Widely used medium to show review teasers to persuade visitors to trust your offerings.', 'notificationx' ) ) . '</span>',
        ];
    }
