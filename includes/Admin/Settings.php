                            ...
                            'fields'   => array(
                                ...
                                'notification_image_size' => [
                                    ...
                                    'options' => GlobalFields::get_instance()->normalize_fields([
                                                '100_100' => __('100 x 100 px', 'notificationx'),
                                                '200_200' => __('200 x 200 px', 'notificationx'),
                                                '300_300' => __('300 x 300 px', 'notificationx'),
                                                '400_400' => __('400 x 400 px', 'notificationx'),
                                                '500_500' => __('500 x 500 px', 'notificationx'),
                                            ]),
                                    'priority' => 20,
                ...
                'email-analytics-reporting'  => apply_filters('nx_settings_tab_email_analytics', [
                    ...
                    'fields'   => [
                        ...
                        'entries_mail_receiver' => apply_filters( 'nx_settings_entries_mail_receiver', array(
                            ...
                            'priority' => 15,
                            'type'     => 'section',
                            'label'    => __( 'Entries Mail Receiver', 'notificationx' ),
                            'fields'   => array(
                                'enable_entries_mail'    => array(
                                    'name'     => 'enable_entries_mail',
                                    'type'     => 'checkbox',
                                    'label'    => __( 'Enable Entries Mail Receiver', 'notificationx' ),
                                    'default'  => false,
                                    'priority' => 0,
                                    'description' => __( 'Send an email notification whenever a new entry is received.', 'notificationx' ),
                                ),
                                ...
                                'entries_mail_from_name' => array(
                                    'name'        => 'entries_mail_from_name',
                                    'type'        => 'text',
                                    'label'       => __( 'From Name', 'notificationx' ),
                                    'default'     => $site_name,
                                    'priority'    => 3,
                                    'description' => __( 'Sender name on the notification email. Defaults to the site name.', 'notificationx' ),
                                    'rules'       => Rules::is( 'enable_entries_mail', true ),
                                ),
                                'entries_mail_from_email' => array(
                                    'name'        => 'entries_mail_from_email',
                                    'type'        => 'text',
                                    'label'       => __( 'From Email', 'notificationx' ),
                                    'default'     => get_option( 'admin_email' ),
                                    'priority'    => 4,
                                    'description' => __( 'Sender address on the notification email. Defaults to the site admin email. Use an address on your own domain so SPF/DKIM pass.', 'notificationx' ),
                                    'rules'       => Rules::is( 'enable_entries_mail', true ),
                                ),
                                'test_entries_mail'      => array(
                                    'name'     => 'test_entries_mail',
                                    'label'    => __( 'Test Mail', 'notificationx' ),
                                    'text'     => __( 'Send Test Email', 'notificationx' ),
                                    'type'     => 'button',
                                    'priority' => 5,
                                    'rules'    => Rules::is( 'enable_entries_mail', true ),
                                    'ajax'     => [
                                        'on'   => 'click',
                                        'api'  => '/notificationx/v1/entries-mail-test',
                                        'data' => [
                                            'entries_mail_email'   => '@entries_mail_email',
                                            'entries_mail_subject' => '@entries_mail_subject',
                                        ],
                                        'swal' => [
                                            'text'      => __( 'Test email sent successfully.', 'notificationx' ),
                                            'icon'      => 'success',
                                            'autoClose' => 2000,
                                        ],
                                    ],
