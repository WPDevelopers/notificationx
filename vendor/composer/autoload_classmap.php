...
return array(
    ...
    'NotificationX\\Abilities\\BuilderInfo' => $baseDir . '/includes/Abilities/BuilderInfo.php',
    ...
    'NotificationX\\Abilities\\Manage\\UpdateNotification' => $baseDir . '/includes/Abilities/Manage/UpdateNotification.php',
    'NotificationX\\Abilities\\Read\\DescribeType' => $baseDir . '/includes/Abilities/Read/DescribeType.php',
    'NotificationX\\Abilities\\Read\\EntriesReader' => $baseDir . '/includes/Abilities/Read/EntriesReader.php',
    'NotificationX\\Abilities\\Read\\ExportEntries' => $baseDir . '/includes/Abilities/Read/ExportEntries.php',
    'NotificationX\\Abilities\\Read\\GetAnalytics' => $baseDir . '/includes/Abilities/Read/GetAnalytics.php',
    'NotificationX\\Abilities\\Read\\GetNotification' => $baseDir . '/includes/Abilities/Read/GetNotification.php',
    'NotificationX\\Abilities\\Read\\GetSettings' => $baseDir . '/includes/Abilities/Read/GetSettings.php',
    'NotificationX\\Abilities\\Read\\GetStatus' => $baseDir . '/includes/Abilities/Read/GetStatus.php',
    'NotificationX\\Abilities\\Read\\ListEntries' => $baseDir . '/includes/Abilities/Read/ListEntries.php',
    'NotificationX\\Abilities\\Read\\ListNotifications' => $baseDir . '/includes/Abilities/Read/ListNotifications.php',
    'NotificationX\\Abilities\\Read\\ListSources' => $baseDir . '/includes/Abilities/Read/ListSources.php',
    'NotificationX\\Abilities\\Read\\ListTypes' => $baseDir . '/includes/Abilities/Read/ListTypes.php',
    'NotificationX\\Abilities\\Registrar' => $baseDir . '/includes/Abilities/Registrar.php',
    ...
    'NotificationX\\Extensions\\WooCommerce\\WooCommerceCartPeek' => $baseDir . '/includes/Extensions/WooCommerce/WooCommerceCartPeek.php',
    ...
    'NotificationX\\MCP\\Bootstrap' => $baseDir . '/includes/MCP/Bootstrap.php',
    'NotificationX\\MCP\\Manager' => $baseDir . '/includes/MCP/Manager.php',
    'NotificationX\\MCP\\OAuth' => $baseDir . '/includes/MCP/OAuth.php',
    'NotificationX\\MCP\\Pairing' => $baseDir . '/includes/MCP/Pairing.php',
    'NotificationX\\MCP\\RateLimiter' => $baseDir . '/includes/MCP/RateLimiter.php',
    'NotificationX\\MCP\\SelfTest' => $baseDir . '/includes/MCP/SelfTest.php',
    'NotificationX\\MCP\\Server' => $baseDir . '/includes/MCP/Server.php',
    'NotificationX\\MCP\\Tools' => $baseDir . '/includes/MCP/Tools.php',
    ...
    'NotificationX\\Types\\WooCommerceCartPeek' => $baseDir . '/includes/Types/WooCommerceCartPeek.php',
    ...
    'WPDeveloper\\QueryBuilder\\Collection' => $vendorDir . '/wpdeveloper/query-builder/src/Collection.php',
    'WPDeveloper\\QueryBuilder\\Interfaces\\Arrayable' => $vendorDir . '/wpdeveloper/query-builder/src/Interfaces/Arrayable.php',
    'WPDeveloper\\QueryBuilder\\Interfaces\\JSONable' => $vendorDir . '/wpdeveloper/query-builder/src/Interfaces/JSONable.php',
    'WPDeveloper\\QueryBuilder\\Interfaces\\Stringable' => $vendorDir . '/wpdeveloper/query-builder/src/Interfaces/Stringable.php',
    'WPDeveloper\\QueryBuilder\\Query' => $vendorDir . '/wpdeveloper/query-builder/src/Query.php',
);
