<div class="nx-settings-documentation">
    <div class="nx-settings-row">
        ...
        <div class="nx-admin-block nx-admin-block-contribute">
            ...
            <div class="nx-admin-block-content">
                <p><?php echo sprintf( '%1$s <a href="%2$s">Github</a>.', __( 'You can contribute to make NotificationX better reporting bugs, creating issues, pull requests at', 'notificationx' ), 'https://github.com/WPDevelopers/notificationx' ); ?></p>
