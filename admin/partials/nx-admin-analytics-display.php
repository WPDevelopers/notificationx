<div class="nx-admin-analytics-wrapper">
    <div class="nx-settings-header">
        <div class="nx-header-left">
            ...
            <h2 class="title">NotificationX Analytics</h2>
        </div>
    ...
    <?php do_action( 'notificationx_after_analytics_header' ); ?>
        ...
        <form action="<?php echo admin_url( 'admin.php?page=nx-analytics' ); ?>" method="GET" class="nx-analytics-form" id="nx-analytics-form">
            ...
            <div class="nx-analytics-form-field nx_notificationx">
                ...
                <select id="nx_notificationx" multiple="multiple" name="notificationx[]">
                    ...
                    ?>
                    <option <?php echo $selected; ?> value="all"><?php _e('All', 'notificationx-pro'); ?></option>
                    <?php 
