    ...
    <div class="fomopress-notification-preview fomopress-notification-preview-conversions">
        <div class="fomopress-preview-inner" <?php FomoPress_Public::generate_preview_css( $settings ); ?>>
            ...
            <div class="fomopress-preview-content">
                <span <?php FomoPress_Public::generate_preview_css( $settings, 'first-row' ); ?> class="fomopress-preview-row fomopress-preview-first-row fomopress-highlight"><?php _e( 'John D. recently purchased', 'notificationx' ); ?></span>
                <span <?php FomoPress_Public::generate_preview_css( $settings, 'second-row' ); ?> class="fomopress-preview-row fomopress-preview-second-row"><?php _e( 'Example Product', 'notificationx' ); ?></span>
                <span <?php FomoPress_Public::generate_preview_css( $settings, 'third-row' ); ?> class="fomopress-preview-row fomopress-preview-third-row"><?php _e( '1 hour ago', 'notificationx' ); ?></span>
            </div>
