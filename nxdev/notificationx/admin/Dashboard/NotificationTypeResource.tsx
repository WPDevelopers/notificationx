...
import { setFieldValue } from 'quickbuilder';
const NotificationTypeResource = ({ props, context }) => {

    useEffect(() => {
        console.log('builder-context', setFieldValue);
    }, [])

    const handleSalesRedirection = () => {
                ...
                <div className='nx-notification-type-body'>
                    <div className='nx-body-content-wrapper'>
                        ...
                        <div className='nx-body-content nx-content-details'>
                            ...
                            <button className='nx-secondary-btn' onClick={handleSalesRedirection}>Create Now</button>
                        </div>
                    </div>
                    <div className='nx-body-content-wrapper'>
