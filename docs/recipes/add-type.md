# Recipe: Add a New Notification Type — End-to-End

> Adding a **data source** for an existing Type (the more common task)? See [add-extension.md](add-extension.md) instead.
